...
var ItemAppModel = new vue__WEBPACK_IMPORTED_MODULE_0___default.a(); //import PopupTempl from '../components/Popup.vue';

vue__WEBPACK_IMPORTED_MODULE_0___default.a.component('Popup', {
  data: function data() {
    return {
      showModal: false,
      item: {
...
var naviApp = new vue__WEBPACK_IMPORTED_MODULE_0___default.a({
  el: '#navi-app',
  data: {
    naviAnker: [],
    nabibutton: false
...
var tabApp = new vue__WEBPACK_IMPORTED_MODULE_0___default.a({
  el: '#tab-app',
  data: {
    tabSelect: 1
  }
