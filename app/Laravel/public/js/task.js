 ...
 */
__webpack_require__(/*! ./bootstrap */ "./resources/js/bootstrap.js"); //?0720 window.Vue = require('vue');
...
//?0720 Vue.component('example-component', require('./components/ExampleComponent.vue').default);
...
var taskApp = new Vue({
  ...
  methods: {
    fetchTasks: function fetchTasks() {
      ...
      axios.get('/api/task-get').then(function (res) {
        console.log("model", res.data);
        _this.tasks = res.data["task"];
    ...
    addTask: function addTask() {
      ...
      axios.post('/api/task-add', {
        ...
        _this2.new_task = '';
        _this2.operation_log = 'タスクを登録しました';
        _this2.set_task_status = true;
        _this2.set_tase = true;
      });
    },
    deleteTask: function deleteTask(task_id) {
      ...
      axios.post('/api/task-del', {
        ...
        _this3.operation_log = 'タスクを削除しました。';
        _this3.set_task_status = true;
        _this3.set_tase = false;
      });
    }
  },
...
Vue.component('task-heading', {
  ...
  renderError: function renderError(ce, err) {
    return ce('pre', {
      style: {
        color: 'red'
      }
